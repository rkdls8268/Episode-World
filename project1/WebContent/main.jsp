	...
	<div class="w3-main w3-content w3-padding"
		...
		<div class="w3-center w3-padding-32">
			<div class="w3-bar">
				...
				<a href="http://localhost:8080/project1/main.jsp" class="w3-bar-item w3-black w3-button">1</a> <a
					href="http://localhost:8080/project1/main2.jsp" class="w3-bar-item w3-button w3-hover-black">2</a>
				<a href="http://localhost:8080/project1/main3.jsp" class="w3-bar-item w3-button w3-hover-black">3</a>
