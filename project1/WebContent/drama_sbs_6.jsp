	...
	<div class="w3-top">
		<div class="w3-bar w3-black w3-card">
			...
			<div class="w3-dropdown-hover w3-hide-small">
				<button class="w3-padding-large w3-button" title="드라마"
					style="margin: 0px">드라마</button>
				<div class="w3-dropdown-content w3-bar-block w3-card-4">
					<a href="drama_kbs.jsp" class="w3-bar-item w3-button">KBS</a> <a
						href="drama_sbs.jsp" class="w3-bar-item w3-button">SBS</a> <a
						href="drama_mbc.jsp" class="w3-bar-item w3-button">MBC</a> <a
						href="drama_tvn.jsp" class="w3-bar-item w3-button">TVN</a> <a
						href="drama_jtbc.jsp" class="w3-bar-item w3-button">JTBC</a>
				</div>
			</div>
			<div class="w3-dropdown-hover w3-hide-small">
				<button class="w3-padding-large w3-button" title="예능"
					style="margin: 0px">예능</button>
				<div class="w3-dropdown-content w3-bar-block w3-card-4">
					<a href="variety_kbs.jsp" class="w3-bar-item w3-button">KBS</a> <a
						href="variety_sbs.jsp" class="w3-bar-item w3-button">SBS</a> <a
						href="variety_mbc.jsp" class="w3-bar-item w3-button">MBC</a> <a
						href="variety_tvn.jsp" class="w3-bar-item w3-button">TVN</a> <a
						href="variety_jtbc.jsp" class="w3-bar-item w3-button">JTBC</a>
				</div>
			</div>
			<div class="w3-dropdown-hover w3-hide-small">
				<button class="w3-padding-large w3-button" title="My_Page"
					style="margin: 0px">My Page</button>
				<div class="w3-dropdown-content w3-bar-block w3-card-4">
					<a href="my_stars.jsp" class="w3-bar-item w3-button">내가 매긴 별점</a> <a
						href="my_comments.jsp" class="w3-bar-item w3-button">내가 쓴 한줄평</a>
					<a href="edit_info.jsp" class="w3-bar-item w3-button">회원 정보 수정</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="w3-main w3-content w3-padding row"
		...
		request.setCharacterEncoding("euc-kr");
			...
			try {
				...
				String query3 = "select * from sys.poster_info where p_title='" + title + "';";
		...
		<div class="mainInfo row">
			<div class="col-12 col-m-12 mainIntro">
				<img class="row col-3 col-m-3 mainImg" src="<%=poster_url%>"
		...
		<div class="row col-12 col-m-12">
			...
			<div class="w3-left">
				<div class="mySlides">
					...
					<div>
						<p>별점과 한줄평을 남겨주세요!</p>
						<form action=drama_sbs_6.jsp method=post>
					...
					if (rating != null) {
						...
						pstmt.setString(3, ep_no[0]); // 다른 회차로 가려면 index 값 바꿔줄 것!
					...
					// 각 방송의 회차별
					String query4 = "select count(*) from sys.rating where rate_title='" + title + "' and rate_ep_no=" + ep_no[0] + ";";
					rs = stmt.executeQuery(query4);
					
					String strn = null;
					int n = 0;
					while(rs.next()){
						strn = rs.getString("count(*)");
					}
					...
					while (rs.next()){
						writer_id[count] = rs.getString("writer_id");
						star[count] = rs.getString("star");
	...
	<div id="id01" class="modal">
		...
		<form class="modal-content animate" action="#" method=post>
			<div class="imgcontainer">
				<span onclick="document.getElementById('id01').style.display='none'"
					...
					src="KakaoTalk_20181213_125826644.png" alt="Avatar" class="avatar">
			</div>

			<div class="container">
				<label for="uname"><b>ID</b></label> <input type="text"
					placeholder="ID를 입력하세요." name="id" required> <label
					for="psw"><b>Password</b></label> <input type="password"
					placeholder="비밀번호를 입력하세요." name="pw" required>
        ...
        <input type="checkbox" checked="checked" name="remember"> Remember me
			...
			<div class="container" style="background-color: #f1f1f1">
				<div class="psw">
					아직 회원이 아니신가요? <a href="join.jsp">회원가입</a> 하러 가기
				</div>
			</div>
		</form>
	</div>
