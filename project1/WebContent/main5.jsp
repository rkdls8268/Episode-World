	...
	<div class="w3-main w3-content w3-padding"
		...
		<div class="w3-row-padding w3-padding-16 w3-center">
			...
			<div class="w3-quarter">
				<img
					src="<%=poster_url[j]%>"
					alt="<%=title[j]%>" style="width: 80%">
				<h4 style><%=title[j]%></h4>
				<p><%=company[j]%> <%=genre[j]%><br /><%=b_date[j]%> <%=b_time[j]%></p>
			</div>
			<% } %>
		</div>
		...
		<div class="w3-center w3-padding-32">
			<div class="w3-bar">
				...
				<a href="http://localhost:8080/project1/main5.jsp" class="w3-bar-item w3-black w3-button">5</a>
