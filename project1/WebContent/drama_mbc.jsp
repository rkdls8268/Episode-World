...
<body>
	<%
	String m_company = "mbc";
	String u_company= "MBC";
	String m_genre = "드라마";
...
%>
	...
	<div class="w3-main w3-content w3-padding"
		...
		try {
			...
			// select b.title, p.poster_url, b.company, b.genre from sys.poster_info p, sys.broadcast_info b where b.company='mbc' And b.genre='드라마' group by b.title;
